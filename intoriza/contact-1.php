                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Contact Pak Gusu</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                        ...
                        <div class="section-head text-center">
                            <div class="wt-separator-outer separator-center">
                                <div class="wt-separator">
                                    <span class="site-text-primary text-uppercase sep-line-one ">Get In Touch</span>
                                </div>
                            </div>
                            <h2>Contact Pak Gusu</h2>
                            <p class="m-t20">Pak Gusu Technology (Pvt.) Ltd.</p>
                        </div>                                            
                        <!-- TITLE END -->                    
                    	<div class="row contact-info-section">
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-lr30 p-tb50  block-shadow">
                                    ...
                                    <div class="icon-content">
                                        <h4>Email address</h4>
                                        <h5>info@pakgusu.com<br>pakgusu@gmail.com</h5>
                            ...
                            <form class="contact-form cons-contact-form" method="post" action="form-handler.php">
                                <div class="contact-one">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input name="project_location" type="text" class="form-control" placeholder="Project Location / City">
                                                <span class="spin"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-12"> 
                                            <div class="form-group">
                                                <textarea name="message" rows="4" class="form-control " required placeholder="Message (brief description of your cleanroom requirement) *"></textarea>
                                                <span class="spin"></span>
                                            </div>
                                        </div>
