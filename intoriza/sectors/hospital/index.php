                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Hospitals & Healthcare</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                    ...
                    <div class="section-content">
                    	<div class="row">
                    		...
                    		<div class="col-lg-5 col-md-12 m-b30">
                                ...
                                <!-- TITLE END -->                            
                                <p>Hospitals require controlled environments for operating theatres and procedure rooms, ICUs, NICUs and isolation rooms, and CSSD and sterile stores.</p>
                                <p>Pak Gusu's partnership with Gusu – a drafting unit for hospital clean operating department standards in China – allows us to translate proven design concepts into the Pakistani context.</p>
