                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Sectors We Serve</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                    ...
                    <div class="section-content">
                    	<div class="row">
                    		...
                    		<div class="col-lg-5 col-md-12 m-b30">
                                ...
                                <!-- TITLE END -->                            
                                <p>Pak Gusu's cleanroom envelopes and accessories are used across a wide range of applications in Pakistan, including Pharmaceutical, Nutraceutical, Hospitals, Food Industry, Electronics, Laboratories, and Medical & Surgical Devices.</p>
                                <p>Each sector has unique requirements, and we design our cleanroom solutions to meet the specific GMP, ISO, and regulatory standards applicable to your industry.</p>
                            	...
                            	<div class="hover-box-effect  v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50 bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Pharmaceutical & Nutraceutical</h4>
                                            <p>GMP-based zoning and flow planning for solid dosage, liquid, injectable and nutraceutical facilities.</p>
                                            <a href="pharmaceutical-nutraceutical/index.php" class="site-button-link" data-hover="Read More">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50  bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Hospitals & Healthcare</h4>
                                            <p>Cleanroom envelopes for operating rooms, critical care units and specialised hospital departments.</p>
                                            <a href="hospital/index.php" class="site-button-link" data-hover="Read More">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                            	<div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50  bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Food Industry</h4>
                                            <p>Cleanroom and hygienic envelope solutions for food and beverage manufacturing and packaging.</p>
                                            <a href="food-industry/index.php" class="site-button-link" data-hover="Read More">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                            	<div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50 bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Electronics</h4>
                                            <p>Cleanroom envelopes suitable for electronics, semiconductor and precision assembly applications.</p>
                                            <a href="electronics/index.php" class="site-button-link" data-hover="Read More">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                            	<div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50 bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Laboratories</h4>
                                            <p>QC, R&D and biosafety laboratories with cleanroom envelopes that integrate with laboratory equipment.</p>
                                            <a href="laboratories/index.php" class="site-button-link" data-hover="Read More">Read More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                            	<div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50 bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Medical & Surgical Devices</h4>
                                            <p>ISO-class production for medical and surgical devices, from plastics to implants and disposables.</p>
                                            <a href="medical-surgical-devices/index.php" class="site-button-link" data-hover="Read More">Read More</a>
                                        </div>
                                    </div>
