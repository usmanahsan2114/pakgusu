                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Electronics & Precision Assembly</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            ...
                            <div>
                                <ul class="wt-breadcrumb breadcrumb-style-2">
                                    ...
                                    <li><a href="<?php echo $root; ?>sectors/index.php">Sectors</a></li>
                                    <li>Electronics</li>
                                </ul>
                            </div>
                    	...
                    	<div class="row">
                    		...
                    		<div class="col-lg-5 col-md-12 m-b30">
                                ...
                                <div class="section-head">
                                    ...
                                    <h2>Electronics & Precision Assembly</h2>
                                </div>
                                <!-- TITLE END -->                            
                                <p>Electronics and precision assembly lines often require low-particle, controlled environments to protect components and ensure product quality.</p>
                                <p>Working with Gusu's experience in <strong>electronics and semiconductor cleanrooms</strong>, we can provide panel and envelope systems suitable for PCB assembly and testing, cable, optical fibre and device assembly, and precision instrument manufacturing.</p>
