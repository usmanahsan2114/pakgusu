                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Cleanroom Panels</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                ...
                <div class="container">
                    ...
                    <div data-aos="fade-down" class="section-head text-center">
                        <div class="wt-separator-outer separator-center">
                            <div class="wt-separator">
                                <span class="site-text-primary text-uppercase sep-line-one ">Panel Types</span>
                            </div>
                        </div>
                        <h2>Panel Types</h2>
                    </div>
                    ...
                    <div class="section-content">
                            	...
                            	<div class="hover-box-effect  v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50 bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">XPS Panels</h4>
                                            <p>Excellent thermal insulation and light weight. Suitable for areas where high insulation and cost-effectiveness are priorities.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50  bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">PU (Polyurethane) Panels</h4>
                                            <p>Higher insulation values with good mechanical properties. Recommended for temperature-controlled areas and where energy efficiency matters.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                            	<div class="hover-box-effect v-icon-effect">
                                    <div data-aos="fade-up" class="wt-icon-box-wraper center p-lr30  p-b50 p-t50  bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">Rockwool Panels</h4>
                                            <p>Fire-resistant and non-combustible core with improved acoustic performance. Ideal for areas requiring higher fire ratings and sound control.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="row m-t30">
                            <div class="col-lg-12 m-b30">
                                <h3 class="m-b20">Typical Applications</h3>
                                <ul class="list-angle-right">
                                    <li>Cleanroom walls and partitions</li>
                                    <li>Walkable ceilings (with appropriate structural build-up)</li>
                                    <li>Airlocks, airlocks/anterooms and technical corridors</li>
                                </ul>
                                <h3 class="m-t30 m-b20">Key Features</h3>
                                <ul class="list-angle-right">
                                    <li>Smooth steel surfaces with durable coatings</li>
                                    <li>Compatible with flush doors, windows and aluminium profiles</li>
                                    <li>Factory-controlled manufacturing for dimensional accuracy</li>
                                    <li>Options for cut-outs and integrated cable or service routes</li>
                                </ul>
                            </div>
                        </div>                                
                    </div>
