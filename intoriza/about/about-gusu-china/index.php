...
<body class="footer-fixed">
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <!-- A RECOGNISED LEADER SECTION START -->
            <div class="section-full p-t80 p-b50 bg-gray">
                <div class="container">
                    ...
                    <div class="section-head text-center">
                        ...
                        <h2>A Recognised Leader in Cleanroom Engineering</h2>
                    </div>
                    <!-- TITLE END -->
                    <div class="section-content">
                    	<div class="row">
                            <div class="col-lg-12 m-b30">
                                <p class="text-center">Gusu is:</p>
                                <ul class="list-check-circle">
                                    <li>A drafting unit for key national standards on cleanroom construction and hospital clean operating departments.</li>
                                    <li>Certified with <strong>ISO 9001</strong>, <strong>ISO 14001</strong> and <strong>OHSAS 18001</strong> management systems.</li>
                                    <li>Licensed as a national Grade II enterprise for air purification, building MEP, intelligent engineering, and interior decoration projects.</li>
                                </ul>
                            </div>
                        </div>                                
                    </div>
            ...
            <!-- A RECOGNISED LEADER SECTION END -->
                        ...
                        <div class="row">
                            <div class="col-lg-12 m-b30">
                                ...
                                <ul class="list-check-circle">
                                    ...
                                    <li>Medical & healthcare facilities, including clean operating rooms</li>
                                    <li>Food, cosmetics and optical cable industries</li>
                                    <li>Research laboratories and education institutions</li>
                                </ul>
                                <p class="m-t30">By partnering with Gusu, Pak Gusu brings this experience and standardisation into Pakistan while remaining accessible and responsive as a local manufacturer.</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- GLOBAL EXPERIENCE SECTION END --> 
