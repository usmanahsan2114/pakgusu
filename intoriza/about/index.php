        ...
        <div class="page-content">
                    ...
                    <div class="section-content">
                    	<div class="row">
                    		...
                    		<div class="col-lg-5 col-md-12 m-b30">
                                ...
                                <!-- TITLE END -->                            
                                <p>Cleanrooms are now an essential requirement across <strong>Pharmaceutical, Nutraceutical, Hospital, Laboratory and Food industries</strong>. For many years, Pakistani manufacturers had no local option: every cleanroom system had to be imported, with challenges such as customs duties, long lead times, installation coordination and after-sales support.</p>
                                <p>Pak Gusu Technology (Pvt.) Ltd. was created to solve this gap.</p>
                            	...
                            	<div class="hover-box-effect  v-icon-effect">
                                    <div class="wt-icon-box-wraper center p-lr30  p-b50 p-t50 bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">2017</h4>
                                            <p>Pak Gusu signed a technical collaboration agreement with Jiangsu Gusu Purification Technology Co. Ltd. (China), one of China's leading cleanroom manufacturers.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>                          
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                            	<div class="hover-box-effect v-icon-effect">
                                    <div class="wt-icon-box-wraper center p-lr30  p-b50 p-t50  bg-white">
                                        ...
                                        <div class="icon-content text-black">
                                            <h4 class="wt-tilte m-b25">2019</h4>
                                            <p>Our plant began commercial production of cleanroom panels, serving Pharmaceutical and related industries across Pakistan.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="list-check-circle">
                                    ...
                                    <li><strong>One-roof solution</strong> – Pak Gusu can support GMP cleanroom projects from:
                                        <ul>
                                            ...
                                            <li>Coordination for HVAC layout and machine positioning</li>
                                            <li>On-site installation of panels, doors, windows and accessories</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="section-full small-device p-t80 p-b50 bg-white">
				<div class="container">
                    ...
                    <!-- TITLE END -->
                    <div class="section-content m-t30">
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="text-center m-b30">Our team includes professionals with:</p>
                                <ul class="list-check-circle">
                                    <li>Pharmaceutical production and validation experience</li>
                                    <li>Mechanical and electrical engineers</li>
                                    <li>Production and quality technicians</li>
                                    <li>Procurement, sales and project coordination specialists</li>
                                </ul>
                                <p class="text-center m-t30">This blend allows us to understand both the compliance side (GMP, ISO) and the practical constraints on Pakistani sites.</p>
                            </div>
                        </div>
                    </div> 
